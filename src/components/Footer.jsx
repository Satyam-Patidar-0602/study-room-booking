        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-1 sm:space-x-2 mb-2 sm:mb-4">
              ...
              <span className="text-base sm:text-xl font-bold">The Study Point Library Jiran</span>
            </div>
            <p className="text-gray-300 mb-2 sm:mb-4 max-w-md text-xs sm:text-base">
              Your perfect study environment with high-speed internet, 
              and a quiet atmosphere designed for maximum productivity. Established on July 10th, 2023 - The first library in Jiran.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-1 sm:space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-white transition-colors text-xs sm:text-base">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/booking" className="text-gray-300 hover:text-white transition-colors text-xs sm:text-base">
                  Book Seat
                </Link>
              </li>
              <li>
                <Link to="/news" className="text-gray-300 hover:text-white transition-colors text-xs sm:text-base">
                  News
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-white transition-colors text-xs sm:text-base">
                  Contact
                </Link>
              </li>
              <li>
                <Link to="/admin" className="text-gray-300 hover:text-white transition-colors text-xs sm:text-base">
                  Admin
                </Link>
              </li>
            </ul>
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-start space-x-2 sm:space-x-3">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-primary-400 transition-colors text-xs sm:text-sm leading-relaxed"
                >
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-gray-300 text-xs sm:text-base">+91 7089290615</span>
              </div>
              <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-gray-300 text-xs sm:text-base">Mon-Sun: 6:30AM-11AM</span>
              </div>
            </div>
          </div>
        </div>
